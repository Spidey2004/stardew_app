        ...
        child: Column(
          ...
          children: [
            ...
            Row(children: List.generate(10, (index) {
              ...
              return IconButton(
                icon: Icon(Icons.favorite, color: filled ? Colors.red : Colors.grey),
                onPressed: () {
                  final newHearts = index + 1 == v.hearts ? index : index + 1;
                  _updateVillager((villager) => villager.hearts = newHearts);
                },
              );
            })),
            ...
            CheckboxListTile(
              ...
              value: v.giftedToday,
              onChanged: (value) => _updateVillager((villager) => villager.giftedToday = value ?? false),
            ),
            const SizedBox(height: 16),
            ...
            Expanded(
              child: TextField(
                ...
                maxLines: null,
                expands: true,
                decoration: const InputDecoration(border: OutlineInputBorder(), hintText: 'Escreva suas anotações...'),
                onChanged: (text) => _updateVillager((villager) => villager.notes = text),
              ),
            ),
          ],
        ),
